...
export default function About() {
  ...
  return (
    ...
    <div>
        ...
        <p style={{marginLeft:10, textAlign:'justify'}}><img src="https://images.pexels.com/photos/269077/pexels-photo-269077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt='Building' class="d-block w-50 mt-4" width={300} height={250} style={{float:'left',marginLeft:10}} />A company, abbreviated as co., is a legal entity representing an association of people, whether natural, 
